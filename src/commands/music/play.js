...
module.exports = {
	...
	async execute(message, args) {
		...
		if (!permissions.has('CONNECT')) return message.channel.send(':no_entry_sign: I cannot connect to your voice channel!');
		if (!permissions.has('SPEAK')) return message.channel.send(':no_entry_sign: I cannot speak in this voice channel!');
